...
Tested up to: 6.5
Tested 'Paid Memberships Pro' plugin up to: 2.12.10
Tested 'Paid Memberships Pro - WooCommerce Add On' plugin up to: 1.7
Tested 'WooCommerce' plugin up to: 8.6.1
Stable tag: 4.0.6
...
= 4.0.6 (2024-09-12) =
~ Check courses on level is out of stock (Max students).
~ Tweak code add courses to order.
~ Remove select2 jQuery library.
