...
This plugin provides a Commission Management system for LearnPress.

== Feature ==

- Management percent commission for each course.
...
= 4.0.1 =
+ Fixed: calculate with coupon of Woo.
+ Added: icon in profile tab.
